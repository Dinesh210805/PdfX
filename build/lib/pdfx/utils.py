...
def print_menu():
    ...
    print(f"{Fore.GREEN}║  {Fore.WHITE}[{Fore.GREEN}9{Fore.WHITE}]{Fore.GREEN} Password-Protect PDF       ║")
    print(f"{Fore.GREEN}║  {Fore.WHITE}[{Fore.GREEN}10{Fore.WHITE}]{Fore.GREEN} Remove PDF Password       ║")
    print(f"{Fore.GREEN}║  {Fore.WHITE}[{Fore.GREEN}11{Fore.WHITE}]{Fore.GREEN} Compress PDF              ║")
    print(f"{Fore.GREEN}║  {Fore.WHITE}[{Fore.GREEN}12{Fore.WHITE}]{Fore.GREEN} Rotate PDF Pages          ║")
    print(f"{Fore.GREEN}║  {Fore.WHITE}[{Fore.GREEN}13{Fore.WHITE}]{Fore.GREEN} Reorder PDF Pages         ║")
    print(f"{Fore.GREEN}║  {Fore.WHITE}[{Fore.GREEN}0{Fore.WHITE}]{Fore.GREEN} {Fore.RED}Exit                      {Fore.GREEN}║")
...
def get_input_files(directory, extensions=None, allow_multiple=False):
    ...
    if not files:
        ...
        if os.path.isfile(custom_path):
            ...
            return None    # Check if user wants all files
    if allow_multiple:
    ...
    if selection.lower() == 'c':
        ...
        if os.path.isfile(custom_path):
            ...
            print(f"{Fore.RED}Invalid file path. Operation canceled.{Style.RESET_ALL}")
            return None    # Handle 'all' for any selection type
